...
#define __BOOST_SML_REQUIRES(...) typename aux::enable_if<__VA_ARGS__, int>::type = 0
                namespace aux {
                    ...
                    template<class T>
                    struct is_empty : aux::integral_constant<bool,
                            sizeof(is_empty_base<T, none_type>) == sizeof(none_type)> {
                    };
                    template<class>
...
struct make_index_sequence_impl {
  using type = typename __make_integer_seq<integer_sequence, int, N>::type;
                    ...
                    struct concat<index_sequence<I1...>, index_sequence<I2...>> : index_sequence<I1..., (sizeof...(I1) +
                                                                                                         I2)...> {
                    };
                    template<int N>
                    struct make_index_sequence_impl
                            : concat<typename make_index_sequence_impl<N / 2>::type, typename make_index_sequence_impl<
                                    N - N / 2>::type>::type {
                    };
                    template<>
                    ...
                    template<class T>
                    struct pool_type_impl<T &, aux::enable_if_t<
                            aux::is_constructible<T>::value && aux::is_constructible<T, T>::value>>
                            : pool_type_base {
                    ...
                    struct missing_ctor_parameter {
                        ...
                        template<class U, __BOOST_SML_REQUIRES(
    ...
    static_assert(missing_ctor_parameter<TMissing>::value,
                  ...
                  "missing type.");
                    ...
                    struct pool : pool_type<Ts> ... {
                        ...
                        template<class... TArgs>
                        pool(init, const pool<TArgs...> &p) : pool_type<Ts>(
                                try_get<aux::remove_const_t<aux::remove_reference_t<Ts>>>(&p))... {}
...
fixed_string(char const (&)[N]) -> fixed_string<N - 1>;
                ...
                namespace back {
                    ...
                    using get_history_states = aux::join_t<
                            typename aux::conditional<!Ts::history &&
                                                      Ts::initial, aux::type_list<typename Ts::src_state>, aux::type_list<>>::type...>;
                    template<class>
                    ...
                    struct sub_sm<sm_impl<sm_policy<T>>> {
                        ...
                        static sm_impl<sm_policy<T, aux::identity<U>, TPolicies...>> &get(
                            ...
                            return static_cast<aux::pool_type<
                                    sm_impl < sm_policy < T, aux::identity<U>, TPolicies...>> > & > (*object).value;
                        }
                        ...
                        cget(const aux::pool_type<sm_impl<sm_policy<T, TPolicies...>>> *object) {
                            return static_cast<const aux::pool_type<sm_impl < sm_policy < T, TPolicies...>> > & >
                                   (*object).value;
                        }
                    };
                    ...
                    struct transitions_sub<sm<TSM>, T, Ts...> {
                        ...
                        static bool execute(const anonymous &event, SM &sm, TDeps &deps, TSubs &subs,
                            ...
                            if (sub_sm < sm_impl < TSM >> ::cget(&subs).is_terminated()) {
                                ...
                                return handled ? handled : transitions<T, Ts...>::execute(event, sm, deps, subs,
                                                                                          current_state);
                            }
                            return false;
                        }
                        ...
                        template<class TEvent, class SM, class TDeps, class TSubs>
                        static bool execute_impl(const TEvent &event, SM &sm, TDeps &deps, TSubs &subs,
                                                 typename SM::state_t &current_state) {
                            const auto handled =
                                    sub_sm < sm_impl < TSM >> ::get(&subs).process_event(event, deps, subs);
                            return handled ? handled : transitions<T, Ts...>::execute(event, sm, deps, subs,
                        ...
                        static bool
                        execute_impl(const back::on_entry<_, TEvent> &event, SM &sm, TDeps &deps, TSubs &subs,
                                     typename SM::state_t &current_state) {
                        ...
                        template<class _, class TEvent, class SM, class TDeps, class TSubs>
                        static bool
                        execute_impl(const back::on_exit<_, TEvent> &event, SM &sm, TDeps &deps, TSubs &subs,
                                     typename SM::state_t &current_state) {
                            sub_sm < sm_impl < TSM >> ::get(&subs).process_event(event, deps, subs);
                            transitions<T, Ts...>::execute(event, sm, deps, subs, current_state);
                            return true;
                ...
                namespace back {
                    ...
                    struct get_event_mapping_impl_helper
                            : aux::conditional<aux::is_same<transitions<aux::true_type>, decltype(get_event_mapping_impl<_>(
                                    (TMappings *) 0))>::value,
                ...
                namespace back {
                    namespace policies {
                        ...
                        struct jump_table {
                            ...
                            static bool
                            dispatch(sm_impl &self, State &current_state, const TEvent &event, TDeps &deps, TSubs &subs,
    ...
    return dispatch_impl<TMappings>(self, current_state, aux::make_index_sequence<sizeof...(TStates)>{}, event, deps, subs,
                ...
                namespace back {
                    ...
                    namespace policies {
                        ...
                        void log_state_change(const aux::type<TLogger> &, TDeps &deps, const TSrcState &,
                                              const TDstState &) {
                            return static_cast<aux::pool_type<TLogger &> &>(deps).value.template log_state_change<SM>(
                                    get_state_name_t < TSrcState > {},
                        ...
                        void log_action(const aux::type<TLogger> &, TDeps &deps, const TAction &action,
                                        const TEvent &event) {
                        ...
                        template<class SM, class TLogger, class TDeps, class TAction, class TEvent>
                        void
                        log_action(const aux::type<TLogger> &, TDeps &deps, const aux::zero_wrapper<TAction> &action,
                                   const TEvent &event) {
                        ...
                        void
                        log_guard(const aux::type<TLogger> &, TDeps &deps, const TGuard &guard, const TEvent &event,
                                  bool result) {
                            return static_cast<aux::pool_type<TLogger &> &>(deps).value.template log_guard<SM>(guard,
                                                                                                               event,
                                                                                                               result);
                        }

                        template<class SM, class TLogger, class TDeps, class TGuard, class TEvent>
                        void log_guard(const aux::type<TLogger> &, TDeps &deps, const aux::zero_wrapper<TGuard> &guard,
                                       const TEvent &event,
                                       bool result) {
                ...
                namespace concepts {
                    ...
                    template<class, class T>
                    struct callable
                            : decltype(test_callable<aux::inherit<aux::conditional_t<__is_class(
                                    T), T, aux::none_type>, callable_fallback>>(0)) {
                    };
...
#define BOOST_SML_DISABLE_EXCEPTIONS false
                ...
                namespace back {
                    ...
                    struct sm_impl
                        ...
                        using state_t = aux::conditional_t<(aux::size<states_t>::value >
                                                            0xFF), unsigned short, aux::byte>;
                        ...
                        template<class TPool>
                        sm_impl(const TPool &p, aux::false_type) : sm_t{aux::try_get<sm_t>(&p)},
                                                                   transitions_{(*this)()} {
                        ...
                        bool process_event(const TEvent &event, TDeps &deps, TSubs &subs) {
                            ...
                            do {
                                ...
                                } while (process_defer_events(deps, subs, handled, aux::type<defer_queue_t < TEvent>>
                                {}, events_t{}));
                            } while (process_queued_events(deps, subs, aux::type<process_queue_t < TEvent>>
                            {}, events_t{}));
                            return handled;
                        }
...
#else
                            (void) aux::swallow{0, (current_state_[region++] = aux::get_id<state_t, TStates>(
                                    (states_ids_t *) 0), 0)...};
#endif
                        }
...
#else
                            return process_event_except_imp < get_event_mapping_t < get_generic_t < TEvent > , mappings
                        ...
                        bool process_internal_events(const TEvent &event, TDeps &deps, TSubs &subs) {
                            policies::log_process_event<sm_t>(aux::type<logger_t>{}, deps, event);
                                                                                   ...
                                                                                   aux::make_index_sequence<regions>{});
#else
                            return process_event_except_imp < get_event_mapping_t < get_mapped_t < TEvent > , mappings
                                    >> (event, deps, subs, has_exceptions{});
#endif
                        }
                        ...
                        template<class TEvent, class TDeps, class TSubs,
                                __BOOST_SML_REQUIRES(aux::is_base_of<get_generic_t<TEvent>, events_ids_t>::value)>
                        bool process_internal_generic_event(const TEvent &event, TDeps &deps, TSubs &subs,
...
#else
                            return process_event_except_imp < get_event_mapping_t < get_mapped_t < TEvent > ,
                                    mappings >> (event, deps, subs, current_state,
                                            has_exceptions{})
                                    #endif
                        ...
                        bool process_event_impl(const TEvent &event, TDeps &deps, TSubs &subs,
                            ...
                            (void) aux::swallow{
                                    0,
                                    (handled |= dispatch_t::template dispatch<0, TMappings>(*this, current_state_[Ns],
                                                                                            event, deps, subs,
                                                                                            states), 0)...};
#endif
                            return handled;
                        ...
                        template<class TMappings, class TEvent, class TDeps, class TSubs>
                        bool
                        process_event_except_imp(const TEvent &event, TDeps &deps, TSubs &subs, state_t &current_state,
                                                 aux::false_type) {
                        ...
                        bool process_defer_events(TDeps &, TSubs &, const bool, const aux::type<no_policy> &,
                        ...
                        bool process_defer_events(TDeps &deps, TSubs &subs, const bool handled,
                            ...
                            if (handled) {
                                ...
                                while (defer_it_ != defer_end_) {
                                    processed_events |= (this->*dispatch_table[defer_it_->id])(deps, subs,
                                                                                               defer_it_->data);
                                    defer_again_ = false;
                                }
                        ...
                        template<class TDeps, class TSubs, class... TEvents>
                        bool process_queued_events(TDeps &, TSubs &, const aux::type<no_policy> &,
                                                   const aux::type_list<TEvents...> &) {
                            return false;
                        }
                        ...
                        bool process_event_no_queue(TDeps &deps, TSubs &subs, const void *data) {
                            ...
                            policies::log_process_event<sm_t>(aux::type<logger_t>{}, deps, event);
                                                                     ...
                                                                     aux::make_index_sequence<regions>{});
#else
                            return process_event_except_imp < get_event_mapping_t < TEvent, mappings
                                    >> (event, deps, subs, has_exceptions{});
#endif
                        }

                        template<class TDeps, class TSubs, class TDeferQueue, class... TEvents>
                        bool process_queued_events(TDeps &deps, TSubs &subs, const aux::type<TDeferQueue> &,
                                                   const aux::type_list<TEvents...> &) {
                            using dispatch_table_t = bool (sm_impl::*)(TDeps &, TSubs &, const void *);
                            const static dispatch_table_t dispatch_table[__BOOST_SML_ZERO_SIZE_ARRAY_CREATE(
                                                                                 sizeof...(TEvents))] = {
...
#else
                            auto result = true;
                            (void) aux::swallow{0, (result &= current_state_[Ns] ==
                    ...
                    public:
                        sm() : deps_{aux::init{}, aux::pool<>{}}, sub_sms_{aux::pool<>{}} {
                            aux::get<sm_impl < TSM>>
                            (sub_sms_).start(deps_, sub_sms_);
                        }

                        template<class TDeps, __BOOST_SML_REQUIRES(
                                !aux::is_same<aux::remove_reference_t<TDeps>, sm>::value)>
                        explicit sm(TDeps &&deps) : deps_{aux::init{}, aux::pool<TDeps>{deps}},
                        ...
                        bool process_event(const TEvent &event) {
                            return aux::get<sm_impl < TSM>>
                            (sub_sms_).process_event(event, deps_, sub_sms_);
                        }

                        template<class TEvent, __BOOST_SML_REQUIRES(!aux::is_base_of<TEvent, events_ids>::value)>
                        bool process_event(const TEvent &event) {
                            return aux::get<sm_impl < TSM>>
                            (sub_sms_).process_event(unexpected_event < _, TEvent > {event}, deps_, sub_sms_);
                        }

                        template<class T = aux::identity<sm_t>, class TVisitor, __BOOST_SML_REQUIRES(
                                concepts::callable<void, TVisitor>::value)>
...
#else
                            (void) aux::swallow{0,
                                                (sm.current_state_[region++] = aux::get_id<state_t, typename TStates::type>(
                                                        (states_ids_t *) 0), 0)...};
#endif
                        }
                ...
                namespace front {
                    ...
                    template<class T, class E>
                    auto
                    args__(int) -> aux::function_traits_t<decltype(&T::__BOOST_SML_TEMPLATE_KEYWORD operator()<back::get_event_t<E>>)>;
                    ...
                    template<class T, class TEvent, class TSM, class TDeps>
                    decltype(auto)
                    get_arg(const aux::type<const TEvent &> &, const back::unexpected_event<T, TEvent> &event, TSM &,
                            TDeps &) {
                        return event.event_;
                    }
                    ...
                    template<class T, class TEvent, class TSM, class TDeps>
                    decltype(auto)
                    get_arg(const aux::type<const TEvent &> &, const back::exception<T, TEvent> &event, TSM &,
                            TDeps &) {
...
#else
                            (void) aux::swallow{
                                    0, (call < TEvent, args_t < Ts, TEvent >, typename TSM::logger_t >
                                                                              ::execute(aux::get_by_id<Ns>(&a), event,
                                                                                        sm, deps, subs),
                                            0)...};
#endif
                        }
            ...
            ...);
                ...
                template<class T1, class T2, __BOOST_SML_REQUIRES(
                        concepts::callable<bool, T1>::value &&concepts::callable<bool, T2>::value)>
                ...
                template<class T1, class T2, __BOOST_SML_REQUIRES(
                        concepts::callable<void, T1>::value &&concepts::callable<void, T2>::value)>
                auto operator,(const T1 &t1, const T2 &t2) {
...
struct sm : back::sm<back::sm_policy<T, TPolicies...>> {
  ...
  using back::sm<back::sm_policy<T, TPolicies...>>::sm;
                ...
                namespace concepts {
                    ...
                    template<class T>
                    auto transitional_impl(
                            T &&t) -> aux::always<typename T::dst_state, typename T::src_state, typename T::event, typename T::deps,
                        ...
                        struct process {
                            ...
                            public:
                                ...
                                void operator()(const T &, TSM &, TDeps &, TSubs &subs) {
                                    aux::get<get_root_sm_t < TSubs>>
                                    (subs).process_.push(event);
                                }
                ...
                namespace front {
                    ...
                    struct transition<state<S1>, transition_sg<state<S2>, G>>
                        ...
                        transition(const state<S1> &, const transition_sg<state<S2>, G> &t)
                                : transition<state<S1>, state<S2>, front::event<back::anonymous>, G, none>{t.g,
                                                                                                           none{}} {}
                    };
   ...
   ...);
                    ...
                    void update_current_state(SM &, TDeps &deps, TSubs &subs, typename SM::state_t &current_state,
                        ...
                        back::policies::log_state_change<typename SM::sm_t>(aux::type<typename SM::logger_t>{}, deps,
                                                                            ...
                                                                            aux::string<T>{});
                        current_state = new_state;
                        update_composite_states < back::sm_impl <
                        T >> (subs, typename back::sm_impl<T>::has_history_states{},
                    ...
                    struct transition<state<S1>, state<S2>, front::event<E>, G, A> {
                        ...
                        bool execute(const TEvent &event, SM &sm, TDeps &deps, TSubs &subs,
                            ...
                            if (call < TEvent, args_t < G, TEvent >, typename SM::logger_t >
                                ...
                                update_current_state(sm, deps, subs, current_state,
                                                     ...
                                                     state < dst_state > {});
                                call < TEvent, args_t < A, TEvent >, typename SM::logger_t >
                                                                     ::execute(a, event, sm, deps, subs);
                    ...
                    struct transition<state<internal>, state<S2>, front::event<E>, G, none> {
                        ...
                        bool execute(const TEvent &event, SM &sm, TDeps &deps, TSubs &subs, typename SM::state_t &,
                                     Ts &&...) {
                            return call < TEvent, args_t < G, TEvent >, typename SM::logger_t >
                                                                        ::execute(g, event, sm, deps, subs);
                        }
                    ...
                    struct transition<state<S1>, state<S2>, front::event<E>, always, none> {
                        ...
                        template<class TEvent, class SM, class TDeps, class TSubs>
                        bool
                        execute(const TEvent &, SM &sm, TDeps &deps, TSubs &subs, typename SM::state_t &current_state,
                                aux::false_type) {
                            update_current_state(sm, deps, subs, current_state,
                                                 aux::get_id<typename SM::state_t, dst_state>(
                                                         (typename SM::states_ids_t *) 0), state < src_state > {},
